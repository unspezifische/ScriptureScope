...
function findWasmBinary() {
  return locateFile('visualization.wasm');
}
...
var ASM_CONSTS = {
  83732: ($0) => { Module.onNodeClick(Pointer_stringify($0)); }
};

// Imports from the Wasm binary.
var _initialize = Module['_initialize'] = makeInvalidEarlyAccess('_initialize');
var _setData = Module['_setData'] = makeInvalidEarlyAccess('_setData');
var _render = Module['_render'] = makeInvalidEarlyAccess('_render');
var _onMouseClick = Module['_onMouseClick'] = makeInvalidEarlyAccess('_onMouseClick');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['setData'] != 'undefined', 'missing Wasm export: setData');
  assert(typeof wasmExports['render'] != 'undefined', 'missing Wasm export: render');
  assert(typeof wasmExports['onMouseClick'] != 'undefined', 'missing Wasm export: onMouseClick');
  ...
  _initialize = Module['_initialize'] = createExportWrapper('initialize', wasmExports['initialize'], 0);
  _setData = Module['_setData'] = createExportWrapper('setData', wasmExports['setData'], 1);
  _render = Module['_render'] = createExportWrapper('render', wasmExports['render'], 0);
  _onMouseClick = Module['_onMouseClick'] = createExportWrapper('onMouseClick', wasmExports['onMouseClick'], 2);
